...
def run_multihead_self_attention(
    ...
    """
    multihead_self_attn: MultiHeadSelfAttention = MultiHeadSelfAttention(
        d_model, num_heads, q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight
    )
    return multihead_self_attn.forward(in_features)
...
def run_rope(
    ...
    """
    rope: RotaryPositionalEmbedding = RotaryPositionalEmbedding(theta, d_k, max_seq_len)
...
def run_transformer_block(
    ...
    """
    transformer_block: TransformerBlock = TransformerBlock(d_model, num_heads, d_ff, max_seq_len, theta, weights)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return get_learning_rate_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
